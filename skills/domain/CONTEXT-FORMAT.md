...
**Single context (this repo):** One glossary at `docs/glossary.md` — never at the repo root.
...
- If neither exists, create `docs/glossary.md` lazily when the first term is resolved — never at the repo root
